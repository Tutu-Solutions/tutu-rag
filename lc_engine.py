    ...
    def __init__(self, index, embed_model):
        ...
        def grade_documents(state):
            ...
            prompt = PromptTemplate(
                ...
                If the document contains keyword(s) from the user question, semantic meaning related to the user question,\n
                or contains potential answer to the user question. grade it as relevant. \n
